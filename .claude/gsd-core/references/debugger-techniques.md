...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/admin/PycharmProjects/mihomo-gateway/.claude
                  → checks C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core
                  → writes to C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/hooks/
