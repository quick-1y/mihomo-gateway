...
```
Agent(
  prompt="Read C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/templates/SECURITY.md`
