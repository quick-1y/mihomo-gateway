...
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/agent-contracts.md
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/context-budget.md
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/gates.md
</required_reading>
...
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/execute-phase-wave-guard.md

@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   Agent(
    ...
    description="Execute plan {plan_number} of phase {phase_number}",
     ...
     prompt="
       ...
       - `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/checkpoints.md`
       ${TDD_APPLICABLE ? '- `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/tdd.md`' : ''}  # #3990/#4265: type: tdd, tdd="true", or workflow.tdd_mode
       - `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/worktree-path-safety.md`
       ${CONTEXT_WINDOW < 200000 ? '' : '- `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/executor-examples.md`'}
       </execution_context>
...
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/execute-phase-quota-recovery.md

@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
**If gaps_found:**
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/workflows/transition.md
</step>
