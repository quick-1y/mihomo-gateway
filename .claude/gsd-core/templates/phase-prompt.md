...
<!-- For checkpoint task examples and patterns, see @C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/checkpoints.md -->
...
See `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/templates/user-setup.md` for full schema and examples
