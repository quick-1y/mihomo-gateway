...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/.gsd-surface.json`
(sibling to `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/skills`).
...
`C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/.gsd-profile`
Skill dirs: `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/skills/gsd-*/`
Engine module: `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
