...
**Verification depth scales with `asvs_level`** (see @C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
