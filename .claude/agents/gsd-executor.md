...
2. If Context7 MCP is not available (custom subagents cannot see project-scoped
   `.mcp.json` servers — they only inherit user-scoped `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/mcp.json`, so a
...
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/ios-scaffold.md
...
@C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/checkpoints.md**
...
**Use template:** @C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/templates/summary.md
