...
<required_reading>
Read `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
