...
**Verification depth scales with `asvs_level`** (full definitions: @C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/references/security-asvs-levels.md):
