...
```
Full template: `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure
Use template from `C:/Users/admin/PycharmProjects/mihomo-gateway/.claude/gsd-core/templates/state.md`. Key sections: Project Reference, Current Position, Performance Metrics, Accumulated Context (decisions, todos, blockers), Session Continuity.
